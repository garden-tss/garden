...
<table >
    ...
    <?php while ($row = $result->fetch_assoc()) { ?>
        <tr>
            ...
            <td>
                <a style="padding: 5px 16.5px;background-color:green; margin: 2px;color:beige ;font-family: Verdana, Geneva, Tahoma, sans-serif; color:beige ; text-decoration: none; " href="edit_user.php?id=<?php echo $row['id']; ?>"><strong>Edit</strong></a> |
                <a style="padding: 5px 16.5px;background-color:red; margin: 2px;color:beige ;font-family: Verdana, Geneva, Tahoma, sans-serif;  text-decoration: none;" href="delete_user.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')"><strong>Delete</strong></a>
            </td>
        </tr>
    <?php } ?>
</table>
