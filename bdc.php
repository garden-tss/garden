...
.hero-background {
    ...
    width: 100%;
    height: 100%;
    background-image: url("./images of garden/bdc2.jpeg");
...
<?php
   ...
   ?>
    ...
    <section class="about">
        ...
        <img src="./images of garden/bdc1.jpeg" alt="Pioneer Construction Logo" class="logo">
    </section>
    ...
    <section class="services">
        ...
        <div class="service-grid">
            ...
            <div class="service-card">
                <img src="./images of garden/back.jpeg" alt="Heavy Civil Construction">
                <h3> Foundation</h3>
            ...
            <div class="service-card">
                <img src="./images of garden/bdc3.jpeg" alt="Reclamation">
